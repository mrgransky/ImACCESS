...
# $ nohup python -u finetune.py -d CINIC10 -bs 128 -ne 32 -lr 1e-4 -wd 1e-2 --print_every 100 -nw 50 --device "cuda:0" -md "ViT-B/32" -fl visual.conv1 visual.ln_pre > /media/volume/ImACCESS/trash/cinic10_finetune.out &

...
# NUM_DATASETS=${#MULTI_LABEL_CSVS[@]} # Number of datasets
...
# # Validate indices
# if [ $dataset_index -ge ${#MULTI_LABEL_CSVS[@]} ] || 
...
# echo "CSV_FILE: ${MULTI_LABEL_CSVS[$dataset_index]}"
...
# echo ">> Starting trainer.py for dataset[$SLURM_ARRAY_TASK_ID]: ${MULTI_LABEL_CSVS[$dataset_index]}"
# python -u trainer.py \

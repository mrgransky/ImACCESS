...
# 										# H4			# NA			# EU				# WWII			# SMU
FINETUNE_STRATEGIES=(
	"full"              # 00-03,  56-59,  	112-115,  	168-171,  	224-227
	"lora"              # 04-07, 	60-63,  	116-119,  	172-175,  	228-231
	"lora_plus"					# 08-11, 	64-67,  	120-123,  	176-179,  	232-235
	"rslora"						# 12-15, 	68-71,  	124-127,  	180-183,  	236-239
	"dora"							# 16-19, 	72-75,  	128-131,  	184-187,  	240-243
	"vera"							# 20-23, 	76-79,  	132-135,  	188-191,  	244-247
	"ia3"								# 24-27, 	80-83,  	136-139,  	192-195,  	248-251
	"clip_adapter_v"		# 28-31, 	84-87,  	140-143,  	196-199,  	252-255
	"clip_adapter_t"		# 32-35, 	88-91,  	144-147,  	200-203,  	256-259
	"clip_adapter_vt"		# 36-39, 	92-95,  	148-151,  	204-207,  	260-263
	"tip_adapter"				# 40-43, 	96-99,  	152-155,  	208-211,  	264-267
	"tip_adapter_f"			# 44-47, 	100-103, 	156-159,  	212-215,  	268-271
	"probe"				      # 48-51, 	104-107, 	160-163,  	216-219,  	272-275
	"zero_shot"         # 52-55, 	108-111, 	164-167,  	220-223,  	276-279
)
##############################################################################

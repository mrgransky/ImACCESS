...
# Single-label:
# $ python inference.py -csv /home/farid/datasets/WW_DATASETs/SMU_1900-01-01_1970-12-31/metadata_single_label.csv -fcp /home/farid/datasets/WW_DATASETs/SMU_1900-01-01_1970-12-31/single_label/full_ViT-B-32_AdamW_OneCycleLR_CrossEntropyLoss_GradScaler_ieps_30_aeps_12_dropout_0.0_lr_1.0e-05_wd_1.0e-02_bs_8_best_model.pth -pcp /home/farid/datasets/WW_DATASETs/SMU_1900-01-01_1970-12-31/results_single_label/progressive_ViT-B-32_AdamW_OneCycleLR_CrossEntropyLoss_GradScaler_ieps_30_aeps_30_dropout_0.0_ilr_1.0e-05_iwd_1.0e-02_bs_8_best_model_last_phase_2_flr_8.8e-06_fwd_0.011085376063548084.pth -lcp /home/farid/datasets/WW_DATASETs/SMU_1900-01-01_1970-12-31/results_single_label/lora_ViT-B-32_AdamW_OneCycleLR_CrossEntropyLoss_GradScaler_ieps_30_aeps_12_lr_1.0e-05_wd_1.0e-02_lor_8_loa_16.0_lod_0.05_bs_8_best_model.pth -a 'ViT-B/32'
# ################ Local ################ 
...
def main():
	...
	for sample in validation_loader:
		...
		print(f"Sample labels for 1st image: {labels[0]}")  # Should show multiple 1s for multi-label
		...
		print(f"Sample labels for 2nd image: {labels[1]}")
	...
	if args.query_image is None or args.query_label is None:
		print("="*80 + "\n")
		print("Systematic selection of samples from validation set: Head, Torso, Tail...")
		if dataset_type == "multi_label":

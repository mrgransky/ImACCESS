...
#SBATCH --output=/lustre/sgn-data/ImACCESS/trash/logs/%x_%a.out # only for testing different img & lbl
#SBATCH --mail-user=farid.alijani@gmail.com
#SBATCH --mail-type=END,FAIL
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=10
#SBATCH --mem=48G # must be adjusted dynamically
...
DATASET_NAMES["/lustre/sgn-data/ImACCESS/WW_DATASETs/HISTORY_X4"]="HISTORY_X4"
DATASET_NAMES["/lustre/sgn-data/ImACCESS/WW_DATASETs/NATIONAL_ARCHIVE_1900-01-01_1970-12-31"]="NATIONAL_ARCHIVE_1900-01-01_1970-12-31"
DATASET_NAMES["/lustre/sgn-data/ImACCESS/WW_DATASETs/EUROPEANA_1900-01-01_1970-12-31"]="EUROPEANA_1900-01-01_1970-12-31"
DATASET_NAMES["/lustre/sgn-data/ImACCESS/WW_DATASETs/WWII_1939-09-01_1945-09-02"]="WWII_1939-09-01_1945-09-02"
DATASET_NAMES["/lustre/sgn-data/ImACCESS/WW_DATASETs/SMU_1900-01-01_1970-12-31"]="SMU_1900-01-01_1970-12-31"
...
full_checkpoints=(
	...
	"${dataset_name}_full_finetune_CLIP_${MODEL_ARCHITECTURES[3]//[@\/]/-}_AdamW_OneCycleLR_CrossEntropyLoss_GradScaler_init_epochs_${INIT_EPOCHS}_actual_epochs_23_dropout_${DROPOUT}_lr_${LR}_wd_${WD}_bs_${ADJUSTED_BATCH_SIZE}_best_model.pth"
)
lora_checkpoints=(

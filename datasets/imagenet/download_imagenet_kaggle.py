...
# Pouta:
# $ nohup python -u download_imagenet_kaggle.py --save_dir /media/volume/ImACCESS/WW_DATASETs/IMAGENET > /media/volume/ImACCESS/trash/download_imagenet.out &
...
def parse_args():
	...
	parser.add_argument('--save_dir', type=str, default='./imagenet_data', help='Directory to save the downloaded dataset (default: ./imagenet_data)')

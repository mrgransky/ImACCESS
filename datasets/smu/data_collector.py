...
# run in Pouta:
# $ nohup python -u data_collector.py -ddir /media/volume/ImACCESS/WW_DATASETs -sdt 1900-01-01 -edt 1970-12-31 -nw 10 --img_mean_std > /media/volume/ImACCESS/trash/smu_data_collection.out &

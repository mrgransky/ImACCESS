...
# run in Pouta:
# $ nohup python -u data_collector.py -ddir /media/volume/ImACCESS/WW_DATASETs -nw 40 -bs 256 --img_mean_std --thumbnail_size 800,800 -v > /media/volume/ImACCESS/trash/smu_data_collection.out &

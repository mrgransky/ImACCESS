...
def _post_process_(
	...
	for idx, labels in enumerate(labels_list):
		...
		for item_idx, item in enumerate(current_items):
			...
			if any(word in lemma for word in ["unknown", "unidentified", "system", "equipment", "component", "supply", "material", "piece", "variant", "part", "series", "chart", "graph", "diagram", "tableau", "plot", "graf", "schematic", "sketch", "sketching",]):
				if verbose:

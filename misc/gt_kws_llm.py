...
- **ABSOLUTELY NO** serial numbers, reference numbers, IDs, technical photo specs, measurements, units, geographic coordinates, or quantitative keywords.
...
- **ABSOLUTELY NO** geographic names such as countries, states, provinces, regions, or cities as standalone keywords - unless they are part of a multi-word n-gram.

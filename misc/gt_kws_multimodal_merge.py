...
# how to run:
# Puhti/Mahti:
# srun -J interactive_cpu --account=project_2014707 --partition=large --time=02-23:45:00 --mem=256G --ntasks=1 --cpus-per-task=40 --pty /bin/bash -i
# $ python -u gt_kws_multimodal_merge.py -ddir /scratch/project_2004072/ImACCESS/_WW_DATASETs/HISTORY_X4/ -nw 40 -v
# $ nohup python -u gt_kws_multimodal_merge.py -ddir /scratch/project_2004072/ImACCESS/_WW_DATASETs/HISTORY_X4 -m "sentence-transformers/all-mpnet-base-v2" -nc 7250 -nw 40 -v > /scratch/project_2004072/ImACCESS/trash/logs/interactive_multimodal_annotation_h4.txt &

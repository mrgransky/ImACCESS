...
# one chunk:
# $ nohup python -u gt_kws_multimodal.py -csv /home/farid/datasets/WW_DATASETs/HISTORY_X4/metadata_multi_label_chunk_1.csv -llm "Qwen/Qwen3-4B-Instruct-2507" -vlm "Qwen/Qwen3-VL-2B-Instruct" -llm_q -vlm_q -vlm_bs 2 -llm_bs 2 -nw 8 -v > logs/multimodal_annotation_chunk_1.txt & 
...
# large models:
# $ python gt_kws_multimodal.py -csv /scratch/project_2004072/ImACCESS/WW_DATASETs/SMU_1900-01-01_1970-12-31/metadata_multi_label.csv -llm "Qwen/Qwen3-Next-80B-A3B-Instruct" -vlm "Qwen/Qwen3-VL-30B-A3B-Instruct" -vlm_bs 16 -llm_bs 96 -nw 40 -v
...
def get_multimodal_annotation(
	...
	if "_chunk_" not in os.path.basename(csv_file):
		...
		if verbose and missing_labels:
			...
			print(f">> canonical_multimodal_labels: {len(canonical_multimodal_labels)}")

...
def generate_caption(img_source: str = "/path/2/test_img/baseball.jpeg", rnd: int=11):
	...
	# Output caption file
	output_caption_fpth = os.path.join(IMG_2_TXT_DIRECTORY, "outputs", f"captioned_img_x{rnd}.txt")
	...
	command = f"cd {IMG_2_TXT_DIRECTORY} && bash run_img_captioning.sh {img_source} {output_caption_fpth}"

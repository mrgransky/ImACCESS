...
print(f"TRAINING for {num_epochs} Epoch(s)".center(150, "-"))
for epoch in range(1, num_epochs + 1):
	...
	if epoch % save_every == 0:
		print(f"Saving checkpoints [Encoder + Decoder] @ epoch: {epoch}", end="\t")
		sv_t = time.time()
		...
		print(f"DONE! => Elapsed_t: {time.time()-sv_t:.3f} sec")

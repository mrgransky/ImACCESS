...
class ConflictQuantifier:
		...
		def compute_asymmetry_gap(self, text_concepts: List[str], vis_concepts: List[str]) -> Dict[str, float]:
				...
				return {
						"V_entails_T": round(avg_v_to_t, 4),
						"T_entails_V": round(avg_t_to_v, 4),
						"gap": round(gap, 4)
				}
...
if __name__ == "__main__":
	run_stage2_audit(input_csv="/home/farid/datasets/WW_DATASETs/EUROPEANA_1900-01-01_1970-12-31/test_vlm_cot.csv", output_jsonl="raw_audit_receipts.jsonl")
...
# Store the replacement_dict into a JSON file
with open(os.path.join(parent_dir, 'misc', 'generalized_labels.json'), 'w') as file_:
	json.dump(replacement_dict, file_, indent=4)
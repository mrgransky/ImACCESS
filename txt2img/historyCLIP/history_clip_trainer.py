...
# run in local:
# $ python history_clip_trainer.py -ddir /home/farid/datasets/WW_DATASETs/SMU_1900-01-01_1970-12-31 -m finetune -fts progressive -e 105 -mphbs 3 -mepph 3 -dt single_label -bs 128 -a "ViT-B/32"
...
# using one command:
# $ nohup python -u history_clip_trainer.py -ddir /media/volume/ImACCESS/WW_DATASETs/SMU_1900-01-01_1970-12-31 -e 200 -bs 256 -lr 5e-5 -wd 1e-2 -nw 32 -dv "cuda:3" -m finetune -fts progressive -dt single_label -a "ViT-B/32" -mep 7 -pat 3 -mepph 3 -mphbs 3 --log_dir /media/volume/ImACCESS/trash &
...
# $ nohup python -u history_clip_trainer.py -ddir /media/volume/ImACCESS/WW_DATASETs/HISTORY_X4 -bs 256 -e 100 -mep 11 -pat 5 -lr 5e-5 -wd 1e-2 -nw 32 -dv "cuda:3" -m finetune -fts progressive -dt single_label -a "ViT-L/14@336px" -do 0.1 -mphbs 3 -mepph 5 --log_dir /media/volume/ImACCESS/trash &
...
def main():
	...
	parser.add_argument('--learning_rate', '-lr', type=float, default=5e-5, help='small learning rate for better convergence [def: 1e-3]')

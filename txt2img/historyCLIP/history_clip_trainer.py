...
# finetune [full]:
# $ nohup python -u history_clip_trainer.py -ddir /media/volume/ImACCESS/WW_DATASETs/SMU_1900-01-01_1970-12-31 -bs 64 -e 150 -lr 1e-6 -wd 1e-2 --print_every 10 -nw 16 -dv "cuda:0" -m finetune -fts full -dt multi_label -a "ViT-B/32" -do 0.05 -mep 10 --log_dir /media/volume/ImACCESS/trash &
...
# $ nohup python -u history_clip_trainer.py -ddir /media/volume/ImACCESS/WW_DATASETs/HISTORY_X4 -bs 128 -e 100 -mep 11 -pat 5 -lr 5e-5 -wd 1e-2 -nw 32 -dv "cuda:3" -m finetune -fts progressive -dt multi_label -a "ViT-L/14@336px" -do 0.1 --log_dir /media/volume/ImACCESS/trash &

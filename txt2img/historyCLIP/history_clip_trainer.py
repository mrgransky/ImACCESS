...
# finetune [full]:
# $ nohup python -u history_clip_trainer.py -ddir /media/volume/ImACCESS/WW_DATASETs/SMU_1900-01-01_1970-12-31 -bs 256 -e 200 -lr 1e-3 -wd 1e-2 --print_every 10 -nw 32 -dv "cuda:0" -m finetune -fts full -dt single_label -a "ViT-B/32" -do 0.1 -mep 10 --log_dir /media/volume/ImACCESS/trash &
...
# $ nohup python -u history_clip_trainer.py -ddir /media/volume/ImACCESS/WW_DATASETs/SMU_1900-01-01_1970-12-31 -bs 64 -e 200 -lr 1e-5 -wd 1e-2 --print_every 50 -nw 32 -dv "cuda:1" -m finetune -fts lora -lor 16 -loa 32.0 -lod 0.1 -dt multi_label -a "ViT-B/32" -mep 6 --log_dir /media/volume/ImACCESS/trash &

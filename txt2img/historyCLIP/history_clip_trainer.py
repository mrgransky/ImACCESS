...
# using one command:
# $ nohup python -u history_clip_trainer.py -ddir /media/volume/ImACCESS/WW_DATASETs/SMU_1900-01-01_1970-12-31 -e 200 -bs 256 -lr 5e-4 -wd 1e-2 -nw 32 -dv "cuda:3" -m finetune -fts progressive -dt single_label -a "ViT-B/32" -do 0.0 -mep 10 -mphbs 3 -mepph 7 --log_dir /media/volume/ImACCESS/trash &

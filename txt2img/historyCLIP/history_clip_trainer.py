...
# using one command:
# $ nohup python -u history_clip_trainer.py -ddir /media/volume/ImACCESS/WW_DATASETs/SMU_1900-01-01_1970-12-31 -e 150 -bs 64 -lr 1e-5 -wd 1e-2 --print_every 10 -nw 10 --device "cuda:0" -m finetune -fts progressive -a "ViT-B/16" -do 0.05 --log_dir /media/volume/ImACCESS/trash &
...
# $ nohup python -u history_clip_trainer.py -ddir /media/volume/ImACCESS/WW_DATASETs/WWII_1939-09-01_1945-09-02 -bs 64 -e 150 -lr 5e-6 -wd 1e-2 --print_every 100 -nw 10 --device "cuda:0" -m finetune -fts progressive -a "ViT-B/16" -do 0.1 --log_dir /media/volume/ImACCESS/trash &
# $ nohup python -u history_clip_trainer.py -ddir /media/volume/ImACCESS/WW_DATASETs/NATIONAL_ARCHIVE_1930-01-01_1955-12-31 -bs 64 -e 100 -lr 1e-4 -wd 1e-2 --print_every 100 -nw 50 --device "cuda:0" -m finetune  -fts progressive -a "ViT-B/16" -do 0.1 --log_dir /media/volume/ImACCESS/trash &
# $ nohup python -u history_clip_trainer.py -ddir /media/volume/ImACCESS/WW_DATASETs/HISTORY_X4 -bs 16 -e 100 -lr 1e-5 -wd 1e-2 --print_every 100 -nw 50 --device "cuda:3" -m finetune -fts progressive -a "ViT-B/16" -do 0.2 --log_dir /media/volume/ImACCESS/trash &

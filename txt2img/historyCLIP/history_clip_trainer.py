...
# $ nohup python -u history_clip_trainer.py -ddir /media/volume/ImACCESS/WW_DATASETs/HISTORY_X4 -bs 32 -e 110 -lr 1e-5 -wd 1e-2 --print_every 500 -nw 20 --device "cuda:2" -m finetune -fts lora --lora_rank 16 --lora_alpha 32.0 --lora_dropout 0.05 -a "ViT-L/14" --log_dir /media/volume/ImACCESS/trash &

...
# using one command:
# $ nohup python -u history_clip_trainer.py -ddir /media/volume/ImACCESS/WW_DATASETs/SMU_1900-01-01_1970-12-31 -e 200 -bs 64 -lr 7e-6 -wd 1e-2 --print_every 12 -nw 32 -dv "cuda:2" -m finetune -fts progressive -dt single_label -a "ViT-B/32" -do 0.1 -mep 6 --log_dir /media/volume/ImACCESS/trash &

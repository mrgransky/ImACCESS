...
# using one command:
# $ nohup python -u history_clip_trainer.py -ddir /media/volume/ImACCESS/WW_DATASETs/SMU_1900-01-01_1970-12-31 -e 110 -bs 256 -lr 3e-4 -wd 1e-2 -nw 32 -dv "cuda:3" -fts progressive -mep 7 -pat 3 -mepph 5 -mphbs 3 -tnp 4 --log_dir /media/volume/ImACCESS/trash &

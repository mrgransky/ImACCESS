...
# run in pouta:
# train from scratch:
# $ nohup python -u history_clip_trainer.py -ddir /media/volume/ImACCESS/WW_DATASETs/SMU_1900-01-01_1970-12-31 -bs 256 -e 100 -lr 1e-4 -wd 1e-3 --print_every 200 -nw 50 --device "cuda:0" -m train -a "ViT-B/32" -do 0.05 > /media/volume/ImACCESS/trash/smu_train.out &

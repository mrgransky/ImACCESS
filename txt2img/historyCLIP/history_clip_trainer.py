...
# $ nohup python -u history_clip_trainer.py -ddir /media/volume/ImACCESS/WW_DATASETs/HISTORY_X4 -bs 8 -e 100 -lr 1e-5 -wd 1e-2 --print_every 100 -nw 24 --device "cuda:3" -m finetune -fts progressive -a "ViT-B/16" -do 0.2 --log_dir /media/volume/ImACCESS/trash &

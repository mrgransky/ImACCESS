...
# run in local:
# $ python history_clip_trainer.py -ddir /home/farid/datasets/WW_DATASETs/SMU_1900-01-01_1970-12-31 -m finetune -fts progressive -e 105 -mphbs 3 -mepph 5 -bs 128 -lr 3e-4 -wd 1e-2 -tnp 8
...
# $ nohup python -u history_clip_trainer.py -ddir /media/volume/ImACCESS/WW_DATASETs/HISTORY_X4 -bs 64 -e 100 -mep 7 -pat 3 -lr 5e-4 -wd 1e-2 -nw 32 -dv "cuda:3" -fts progressive -mphbs 3 -mepph 5 -tnp 8 --print_every 2500 --log_dir /media/volume/ImACCESS/trash &

...
# $ nohup python -u history_clip_trainer.py -ddir /media/volume/ImACCESS/WW_DATASETs/EUROPEANA_1900-01-01_1970-12-31 -bs 64 -e 150 -lr 5e-6 -wd 1e-2 --print_every 50 -nw 50 --device "cuda:1" -m finetune -fts progressive -a "ViT-B/32" -do 0.1 --log_dir /media/volume/ImACCESS/trash &
# $ nohup python -u history_clip_trainer.py -ddir /media/volume/ImACCESS/WW_DATASETs/WWII_1939-09-01_1945-09-02 -bs 64 -e 150 -lr 5e-5 -wd 1e-2 --print_every 100 -nw 50 --device "cuda:2" -m finetune -fts progressive -a "ViT-B/32" -do 0.05 --log_dir /media/volume/ImACCESS/trash &

...
# $ nohup python -u history_clip_trainer.py -ddir /media/volume/ImACCESS/WW_DATASETs/HISTORY_X4 -bs 32 -e 100 -mep 7 -pat 3 -lr 1e-4 -wd 1e-2 -nw 32 -dv "cuda:3" -fts progressive -mphbs 3 -mepph 5 -tnp 8 --log_dir /media/volume/ImACCESS/trash &

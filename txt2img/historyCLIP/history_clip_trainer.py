...
# using one command:
# $ nohup python -u history_clip_trainer.py -ddir /media/volume/ImACCESS/WW_DATASETs/SMU_1900-01-01_1970-12-31 -e 100 -bs 256 -lr 1e-4 -wd 3e-2 -nw 32 -dv "cuda:3" -m finetune -fts progressive -dt single_label -a "ViT-B/32" -do 0.0 -mep 7 -pat 5 -mepph 5 -mphbs 3 --log_dir /media/volume/ImACCESS/trash &
...
def main():
	...
	parser.add_argument('--weight_decay', '-wd', type=float, default=2e-2, help='Weight decay [def: 5e-4]')

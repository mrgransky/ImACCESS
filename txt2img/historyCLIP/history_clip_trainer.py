...
# finetune [full]:
# $ nohup python -u history_clip_trainer.py -ddir /media/volume/ImACCESS/WW_DATASETs/SMU_1900-01-01_1970-12-31 -bs 64 -e 150 -lr 1e-6 -wd 1e-2 --print_every 10 -nw 24 --device "cuda:3" -m finetune -fts full -a "ViT-B/32" -do 0.05 -mep 10 --log_dir /media/volume/ImACCESS/trash &
# $ nohup python -u history_clip_trainer.py -ddir /media/volume/ImACCESS/WW_DATASETs/EUROPEANA_1900-01-01_1970-12-31 -bs 64 -e 150 -lr 5e-6 -wd 1e-2 --print_every 200 -nw 12 --device "cuda:1" -m finetune -fts full -a "ViT-B/32" -do 0.05 --log_dir /media/volume/ImACCESS/trash &
...
# $ nohup python -u history_clip_trainer.py -ddir /media/volume/ImACCESS/WW_DATASETs/EUROPEANA_1900-01-01_1970-12-31 -bs 64 -e 150 -lr 1e-5 -wd 1e-2 --print_every 200 -nw 50 --device "cuda:1" -m finetune -fts lora --lora_rank 8 --lora_alpha 16.0 --lora_dropout 0.05 -a "ViT-B/32" --log_dir /media/volume/ImACCESS/trash &
...
# $ nohup python -u history_clip_trainer.py -ddir /media/volume/ImACCESS/WW_DATASETs/HISTORY_X4 -bs 64 -e 150 -lr 1e-5 -wd 1e-2 --print_every 250 -nw 50 --device "cuda:1" -m finetune -fts lora --lora_rank 4 --lora_alpha 32.0 --lora_dropout 0.0 -a "ViT-B/32" --log_dir /media/volume/ImACCESS/trash &
...
# using one command:
# $ nohup python -u history_clip_trainer.py -ddir /media/volume/ImACCESS/WW_DATASETs/SMU_1900-01-01_1970-12-31 -e 150 -bs 64 -lr 1e-5 -wd 1e-2 --print_every 10 -nw 10 --device "cuda:1" -m finetune -fts progressive -a "ViT-B/32" -do 0.05 -mep 10 --log_dir /media/volume/ImACCESS/trash &
# $ nohup python -u history_clip_trainer.py -ddir /media/volume/ImACCESS/WW_DATASETs/EUROPEANA_1900-01-01_1970-12-31 -bs 64 -e 150 -lr 5e-6 -wd 1e-2 --print_every 50 -nw 50 --device "cuda:2" -m finetune -fts progressive -a "ViT-B/32" -do 0.05 --log_dir /media/volume/ImACCESS/trash &
...
def main():
	...
	parser.add_argument('--learning_rate', '-lr', type=float, default=1e5, help='small learning rate for better convergence [def: 1e-3]')

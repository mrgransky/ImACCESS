...
# run in local:
# $ python history_clip_trainer.py -ddir /home/farid/datasets/WW_DATASETs/SMU_1900-01-01_1970-12-31 -m finetune -fts progressive -e 105 -mphbs 3 -mepph 5 -dt single_label -bs 128 -lr 1e-4 -wd 1e-2
...
# using one command:
# $ nohup python -u history_clip_trainer.py -ddir /media/volume/ImACCESS/WW_DATASETs/SMU_1900-01-01_1970-12-31 -e 200 -bs 256 -lr 3e-4 -wd 1e-2 -nw 32 -dv "cuda:3" -m finetune -fts progressive -dt single_label -mep 7 -pat 3 -mepph 5 -mphbs 3 --log_dir /media/volume/ImACCESS/trash &

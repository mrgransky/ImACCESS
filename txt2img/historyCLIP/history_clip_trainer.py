...
# finetune [full]:
# $ nohup python -u history_clip_trainer.py -ddir /media/volume/ImACCESS/WW_DATASETs/SMU_1900-01-01_1970-12-31 -bs 64 -e 100 -lr 1e-5 -wd 1e-1 --print_every 50 -nw 50 --device "cuda:1" -m finetune -a "ViT-B/32" -do 0.05 --log_dir /media/volume/ImACCESS/trash &
...
# finetune [lora]:
# $ nohup python -u history_clip_trainer.py -ddir /media/volume/ImACCESS/WW_DATASETs/SMU_1900-01-01_1970-12-31 -bs 64 -e 150 -lr e-5 -wd 1e-1 --print_every 50 -nw 50 --device "cuda:1" -m finetune -fts lora --lora_rank 8 --lora_alpha 16 --lora_dropout 0.05 -a "ViT-B/32" -do 0.0 --log_dir /media/volume/ImACCESS/trash &
...
# using one command:
# $ nohup python -u history_clip_trainer.py -ddir /media/volume/ImACCESS/WW_DATASETs/SMU_1900-01-01_1970-12-31 -e 150 -bs 64 -lr 1e-5 -wd 1e-2 --print_every 10 -nw 10 --device "cuda:1" -m finetune -fts progressive -a "ViT-B/16" -do 0.05 --log_dir /media/volume/ImACCESS/trash &

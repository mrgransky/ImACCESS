...
# run in pouta:
# $ nohup python -u history_clip.py -ddir /media/volume/ImACCESS/WW_DATASETs/HISTORICAL_ARCHIVES -bs 260 -ne 30 -lr 1e-5 -wd 3e-3 --print_every 100 -nw 20 --device "cuda:1" > /media/volume/ImACCESS/trash/finetune_historyCLIP_frozen_4layers_cuda1.out &

...
# $ nohup python -u train.py -ddir /media/volume/ImACCESS/WW_DATASETs/NATIONAL_ARCHIVE_1935-01-01_1950-12-31 -nep 30 --device "cuda:2" -lr 1e-3 -wd 5e-2 -ps 5 -is 160 -bs 63 -nw 20 -vds 0.25 > /media/volume/trash/ImACCESS/historyCLIP_train_NA_val_NA_cuda2.out &

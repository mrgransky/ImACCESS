...
# $ nohup python -u train.py -ddir /media/volume/ImACCESS/WW_DATASETs/NATIONAL_ARCHIVE_1935-01-01_1950-12-31 -nep 30 --device "cuda:3" -lr 1e-4 -wd 5e-2 -ps 5 -is 180 -bs 64 -nw 40 > /media/volume/trash/ImACCESS/historyCLIP_train_NA_val_NA_cuda3.out &

...
# $ nohup python -u train.py -ddir /media/volume/ImACCESS/WW_DATASETs/NATIONAL_ARCHIVE_1935-01-01_1950-12-31 -vddir /media/volume/ImACCESS/WW_DATASETs/EUROPEANA_1900-01-01_1970-12-31 -nep 13 --device "cuda:2" -lr 5e-4 -wd 5e-2 -ps 5 -is 160 -bs 64 > /media/volume/trash/ImACCESS/historyCLIP_train_NA_val_EUROPEANA_cuda2.out &

# with splited dataset of NA:
# $ nohup python -u train.py -ddir /media/volume/ImACCESS/WW_DATASETs/NATIONAL_ARCHIVE_1935-01-01_1950-12-31 -nep 40 --device "cuda:1" -lr 1e-4 -wd 5e-2 -ps 5 -is 160 -bs 64 -nw 40 > /media/volume/trash/ImACCESS/historyCLIP_train_NA_val_NA_cuda1.out &
